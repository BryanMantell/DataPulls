...
SAVE OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ4OIUS_Constructs.sav'
  /COMPRESSED.
...
FREQ VARS=FQ4OIUS01, FQ4OIUS02, FQ4OIUS03, FQ4OIUS04, FQ4OIUS05, FQ4OIUS06, FQ4OIUS07, FQ4OIUS08, FQ4OIUS09, 
    FQ4OIUS10, FQ4OIUS11, FQ4OIUS12.
*IUS Total Score.
CORR VARS=FQ4OIUS01, FQ4OIUS02, FQ4OIUS03, FQ4OIUS05, FQ4OIUS06, FQ4OIUS07, FQ4OIUS08, FQ4OIUS09, 
    FQ4OIUS10, FQ4OIUS11, FQ4OIUS12.
*IUS Prospective Anxiety (PA).
CORR VARS=FQ4OIUS01 FQ4OIUS02 FQ4OIUS03 FQ4OIUS04 FQ4OIUS05 FQ4OIUS06 FQ4OIUS07.
*IUS Inhibitory Anxiety (IA).
CORR VARS=FQ4OIUS08 FQ4OIUS09 FQ4OIUS10 FQ4OIUS11 FQ4OIUS12.

*STEP 4: RECODING MISSING VALUES.
RECODE FQ4OIUS01 TO FQ4OIUS12 (MISSING=-9999).
EXECUTE.
    
*STEP 5: RELIABILITY STATISTICS (TOTAL SCORE 1st, FOLLOWED BY SUBSCALES).
*IUS Total Score (12 items; n=58; alpha=.901).
REL VARS=FQ4OIUS01 FQ4OIUS02 FQ4OIUS03 FQ4OIUS04 FQ4OIUS05 FQ4OIUS06 FQ4OIUS07 FQ4OIUS08 FQ4OIUS09 
    FQ4OIUS10 FQ4OIUS11 FQ4OIUS12
/SCALE(All)= ALL.
*IUS Prospective Anxiety (PA) (7 items; n=58; alpha=.858).
REL VARS=FQ4OIUS01 FQ4OIUS02 FQ4OIUS03 FQ4OIUS04 FQ4OIUS05 FQ4OIUS06 FQ4OIUS07
/SCALE(All)= ALL.
*IUS Inhibitory Anxiety (IA) (5 items; n=59; alpha=.814).
REL VARS=FQ4OIUS08 FQ4OIUS09 FQ4OIUS10 FQ4OIUS11 FQ4OIUS12
/SCALE(All)= ALL.

*STEP 6: COUNTING MISSING DATA (JUST SUBSCALES), THEN RECODING TO 0 TO AVOID NEGATIVE EFFECTS ON CONSTRUCTS.
*IUS TOTAL (TOT).
COUNT MISSTOT=FQ4OIUS01 FQ4OIUS02 FQ4OIUS03 FQ4OIUS05 FQ4OIUS06 FQ4OIUS07 FQ4OIUS08 FQ4OIUS09 
    FQ4OIUS10 FQ4OIUS11 FQ4OIUS12 (-9999).
*IUS Prospective Anxiety (PA).
COUNT MISSPA=FQ4OIUS01 FQ4OIUS02 FQ4OIUS03 FQ4OIUS05 FQ4OIUS06 FQ4OIUS07 (-9999).
*IUS Inhibitory Anxiety (IA).
COUNT MISSIA=FQ4OIUS08 FQ4OIUS09 FQ4OIUS10 FQ4OIUS11 FQ4OIUS12 (-9999).

RECODE FQ4OIUS01 TO FQ4OIUS12 (-9999=0).
EXECUTE.
...
COMPUTE FQ4OIUSTOT=-9999.
EXECUTE.
IF (MISSTOT < 3.96) FQ4OIUSTOT=RND(((FQ4OIUS01 + FQ4OIUS02 + FQ4OIUS03 + FQ4OIUS04 + FQ4OIUS05 + FQ4OIUS06 + FQ4OIUS07 + FQ4OIUS08 + FQ4OIUS09 + 
    FQ4OIUS10 + FQ4OIUS11 + FQ4OIUS12)/(12-MISSTOT))*12).
EXECUTE.
*IUS Prospective Anxiety (PA) (7 items) --  66.7% (i.e., if MISS is less than or equal to 2.31) as a cut-off point.
COMPUTE FQ4OIUSPA=-9999.
EXECUTE.
IF (MISSPA < 2.31) FQ4OIUSPA=RND(((FQ4OIUS01 + FQ4OIUS02 + FQ4OIUS03 + FQ4OIUS04 + FQ4OIUS05 + FQ4OIUS06 + FQ4OIUS07)/(7-MISSTOT))*7).
EXECUTE.
*IUS Inhibitory Anxiety (IA) (5 items) --  66.7% (i.e., if MISS is less than or equal to 1.65) as a cut-off point.
COMPUTE FQ4OIUSIA=-9999.
EXECUTE.
IF (MISSIA < 1.65) FQ4OIUSIA=RND(((FQ4OIUS08 + FQ4OIUS09 + FQ4OIUS10 + FQ4OIUS11 + FQ4OIUS12)/(5-MISSTOT))*5).
EXECUTE.
...
DO REPEAT x = FQ4OIUSTOT TO FQ4OIUSIA.
RECODE FD4OSTAT (ELSE=COPY) INTO x.
END REPEAT.
END IF.
EXECUTE.
*Checking frequenices for constructs to look at missingness. 
FREQUENCIES VARIABLES=FD4OSTAT FQ4OIUSTOT FQ4OIUSPA FQ4OIUSIA
  /ORDER=ANALYSIS.
...
OR ID=91858 OR ID=91533) FQ4OIUSTOT=-41.
EXECUTE.
...
OR ID=91069 OR ID=91081 OR ID=91123 OR ID=91133 OR ID=91165 OR ID=91260
OR ID=91292 OR ID=91469 OR ID=91548 OR ID=91637 OR ID=91759 OR ID=91768
OR ID=91858 OR ID=91533) FQ4OIUSPA=-41.
EXECUTE.
...
OR ID=91069 OR ID=91081 OR ID=91123 OR ID=91133 OR ID=91165 OR ID=91260
OR ID=91292 OR ID=91469 OR ID=91548 OR ID=91637 OR ID=91759 OR ID=91768
OR ID=91858) FQ4OIUSIA=-41.
EXECUTE.

IF (ID=91533) FQ4OIUSTOT=-44.
EXECUTE.
IF (ID=91533) FQ4OIUSPA=-44.
EXECUTE.
IF (ID=91533) FQ4OIUSIA=-44.
EXECUTE.

IF (FQ4OIUSTOT=-9999) FQ4OIUSTOT=-43.
EXECUTE.  
IF (FQ4OIUSPA=-9999) FQ4OIUSPA=-43.
EXECUTE.  
IF (FQ4OIUSIA=-9999) FQ4OIUSIA=-43.
EXECUTE.  

MISSING VALUES
   FQ4OIUSTOT FQ4OIUSPA FQ4OIUSIA
    (LO THRU -1).
EXECUTE.

*STEP 9: LABELING CONSTRUCTS.
VARIABLE LABELS
FQ4OIUSTOT 'IUS Total Score [FQ4OIUSTOT]'
FQ4OIUSPA 'IUS Prospective Anxiety [FQ4OIUSPA]'
FQ4OIUSIA 'IUS Inhibitory Anxiety [FQ4OIUSIA]'.
EXECUTE.
...
DESCRIPTIVES VARIABLES=FQ4OIUSTOT FQ4OIUSPA FQ4OIUSIA
...
SORT CASES BY ID(A).
SAVE OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ4OIUS_Constructs.sav'
  /KEEP ID FD4ORD FQ4OIUSTOT FQ4OIUSPA FQ4OIUSIA 
  /COMPRESSED.
GET
  FILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ4OIUS_Constructs.sav'.
EXECUTE.

*STEP 13: SAVE OUTPUT FILE.
*Be sure that you have a 'clean' output file. Re-run syntax once you are sure there are no errors and save with frequencies and descriptives.
OUTPUT SAVE 
 OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ4OIUS_Constructs.spv'
LOCK=NO.
