...
*3-09-22(BM): Adapted syntax for A2.
*3-09-22(AAC): Checked. Added alpha to syntax. 

*--------------------------------------------------------------------------------------------------------------------------------.
*STEP 1: OPENING CLEANED DATA.
*Insert the correct file path and file name. Use syntax to open cleaned data file.
GET
  FILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ2OAAQ_Cleaned.sav'.

*STEP 2: SAVING CLEANED DATA AS A CONSTRUCT FILE. 
*Insert the correct file path and file name.
SAVE OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ2OAAQ_Constructs.sav'
  /COMPRESSED.
...
FREQ VARS=FQ2OAAQ01R FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ06R FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 FQ2OAAQ10R. 
*AAQ Total Score 7 items (TOT7).
CORR VARS=FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09. 
*AAQ Total Score 10 items (TOT10).
CORR VARS=FQ2OAAQ01R FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ06R FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 FQ2OAAQ10R. 
    
*STEP 4: RECODING MISSING VALUES.
RECODE FQ2OAAQ01 TO FQ2OAAQ10R (MISSING=-9999).
EXECUTE.

*STEP 5: RELIABILITY STATISTICS (TOTAL SCORE 1st, FOLLOWED BY SUBSCALES).
*AAQ Total Score 7 items (TOT7) (7 items; n=62; alpha=.957).
REL VARS=FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 
/SCALE(All)= ALL.
*AAQ Total Score 10 items (TOT10) (10 items; n=62; alpha=.937).
REL VARS=FQ2OAAQ01R FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ06R FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 FQ2OAAQ10R
/SCALE(All)= ALL.

*STEP 6: COUNTING MISSING DATA (JUST SUBSCALES), THEN RECODING TO 0 TO AVOID NEGATIVE EFFECTS ON CONSTRUCTS.
*AAQ Total Score 7 items (TOT7).
COUNT MISSTOT7=FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 (-9999).
*AAQ Total Score 10 items (TOT10).
COUNT MISSTOT10=FQ2OAAQ01R FQ2OAAQ02 FQ2OAAQ03 FQ2OAAQ04 FQ2OAAQ05 FQ2OAAQ06R FQ2OAAQ07 FQ2OAAQ08 FQ2OAAQ09 FQ2OAAQ10R (-9999).

RECODE FQ2OAAQ01 TO FQ2OAAQ10R (-9999=0).
EXECUTE.
...
COMPUTE FQ2OAAQTOT10=-9999.
EXECUTE.
IF (MISSTOT10 < 3.30) FQ2OAAQTOT10=RND(((FQ2OAAQ01R + FQ2OAAQ02 + FQ2OAAQ03 + FQ2OAAQ04 + FQ2OAAQ05 + FQ2OAAQ06R + FQ2OAAQ07 + FQ2OAAQ08 + FQ2OAAQ09 + FQ2OAAQ10R)/(10-MISSTOT10))*10).
EXECUTE.
*AAQ Total Score (TOT7) (7 items) -- USE MISSINGNESS FOR EACH SUBSCALE as a cut-off point.
COMPUTE FQ2OAAQTOT7=-9999.
EXECUTE.
IF (MISSTOT7 < 2.31) FQ2OAAQTOT7=RND(((FQ2OAAQ02 + FQ2OAAQ03 + FQ2OAAQ04 + FQ2OAAQ05 + FQ2OAAQ07 + FQ2OAAQ08 + FQ2OAAQ09)/(7-MISSTOT7))*7).
EXECUTE.
...
DO REPEAT x = FQ2OAAQTOT7 FQ2OAAQTOT10.
RECODE FD2OSTAT (ELSE=COPY) INTO x.
END REPEAT.
END IF.
EXECUTE.
*Checking frequenices for constructs to look at missingness. 
FREQUENCIES VARIABLES=FD2OSTAT FQ2OAAQTOT7 FQ2OAAQTOT10
  /ORDER=ANALYSIS.
...
IF (FQ2OAAQTOT7=-9999) FQ2OAAQTOT7=-43.
EXECUTE.  
IF (FQ2OAAQTOT10=-9999) FQ2OAAQTOT10=-43.
EXECUTE.  
MISSING VALUES
   FQ2OAAQTOT7 FQ2OAAQTOT10
    (LO THRU -1).
EXECUTE.

*STEP 9: LABELING CONSTRUCTS.
VARIABLE LABELS
FQ2OAAQTOT7 'AAQ Total Score 7 items [FQ2OAAQTOT7]'
FQ2OAAQTOT10 'AAQ Total Score 10 items [FQ2OAAQTOT10]'.
EXECUTE.
...
DESCRIPTIVES VARIABLES=FQ2OAAQTOT7 FQ2OAAQTOT10 
...
SORT CASES BY ID(A).
SAVE OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ2OAAQ_Constructs.sav'
  /KEEP ID FD2ORD FQ2OAAQTOT7 FQ2OAAQTOT10 
  /COMPRESSED.
GET
  FILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ2OAAQ_Constructs.sav'.
EXECUTE.

*STEP 13: SAVE OUTPUT FILE.
*Be sure that you have a 'clean' output file. Re-run syntax once you are sure there are no errors and save with frequencies and descriptives.
OUTPUT SAVE 
 OUTFILE='/Users/alexisadams-clark/Desktop/DBT Moms data management/FQ2OAAQ_Constructs.spv'
LOCK=NO.
